...
def composer(func=lambda x: x):
    ...
    9
    """
    ### have not gotten used to this thinking model!
    def func_adder(g):
        def h(x):
            return func(g(x))
        return composer(h)
...
def g_iter(n):
    ...
    if n <= 3:
        ...
        g_1, g_2, g_3, i = 3, 2, 1, 4
        while i <= n:
            g_1, g_2, g_3, i = g_1 + 2 * g_2 + 3 * g_3, g_1, g_2, i + 1
        return g_1
...
def missing_digits(n):
    ...
    if n < 10:  
        ...
        if a == b:
            ...
            return missing_digits(n // 10) + a - b - 1
